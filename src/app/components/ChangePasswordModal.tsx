...
import { getCustomerPassword, setCustomerPassword } from "../../utils/passwordUtils";
...
export function ChangePasswordModal({ email, onClose }: ChangePasswordModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const stored = getCustomerPassword(email);
    if (!stored) {
      setError("No password set. Please use the sign-up process first.");
      return;
    }
    ...
    setCustomerPassword(email, newPassword);
    setSuccess(true);
