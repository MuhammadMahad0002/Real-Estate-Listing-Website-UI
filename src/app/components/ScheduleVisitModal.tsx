...
const TIME_SLOTS = ["Morning (9–12 AM)", "Afternoon (12–4 PM)", "Evening (4–7 PM)"];
        ...
        >
          ...
          {submitted ? (
            <div className="p-8 text-center">
              ...
              <h3
                className="text-xl text-[#0A1628] mb-2"
                style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800 }}
              >
                Visit Scheduled!
              </h3>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4" noValidate>
              ...
              <div>
                <label
                  className="block text-xs text-[#0A1628] mb-2"
                  style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600 }}
                >
                ...
                <div className="grid grid-cols-3 gap-2">
                  {TIME_SLOTS.map((slot) => (
                    ...
                    >
                      {slot.split(" ")[0]}
                      <br />
                      <span style={{ fontWeight: 400 }} className="text-xs">
                        {slot.match(/\((.+)\)/)?.[1]}
                      </span>
                    </button>
                  ))}
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-3 rounded-lg text-sm text-[#0A1628] transition-all hover:brightness-110 active:scale-[0.98]"
                  style={{
                    background: "#D4A853",
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
                    fontWeight: 700,
      ...
      <div
        className={`flex items-center gap-2 border rounded-lg px-3 py-2.5 transition-colors ${
          error
            ...
            : "border-gray-200 bg-[#F5F7FA] focus-within:border-[#D4A853]"
        }`}
      >
